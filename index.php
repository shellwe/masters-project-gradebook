...
<!-- InstanceBeginEditable name="doctitle" -->
  <title>tests R us - homepage</title>
  <!-- InstanceEndEditable -->
...
?>
<div class="pull-right"><h4>Welcome <?php echo $row['first']?> <?php echo $row['last']?>!</h4></div>
...
?>
<a href="student-tests.php">Click here</a> to find out what tests you can take
<div class="<?php echo  @$resultarray['message_type']?>"><?php echo  @$resultarray['announcement']?></div>
<div class="hero-unit"><?php echo  @$resultarray['name']?></div>
<div class="well"><?php echo  @$resultarray['description']?></div>
